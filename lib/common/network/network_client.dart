...
import 'package:indoxx1/common/error/api_error.dart';
import 'package:indoxx1/common/model/response_data.dart';
import 'package:indoxx1/common/network/http_constant.dart';
import 'package:indoxx1/data/auth/datasources/session_manager.dart';
import 'package:path/path.dart';

abstract class NetworkClient {
  Future<ResponseData> get(String url, {Map<String, String> headers});

  Future<ResponseData> post(String url, {Map<String, String> headers, body, Encoding encoding});

  Future<ResponseData> put(String url, {Map<String, String> headers, body, Encoding encoding});
