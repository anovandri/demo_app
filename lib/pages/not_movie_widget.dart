...
class NotMovieWidget extends StatelessWidget {
  ...
  final upperContentCornerRadius = const Radius.circular(8);

  const NotMovieWidget(
      {@required this.notMovieTitle, @required this.notMovieYear, this.notMoviePosterUrl});
  ...
  Widget build(BuildContext context) {
    ...
    return _softUIStyleWidget(context, posterWidget: posterWidget);
  }
