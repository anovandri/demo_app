...
class MovieFavoriteListView extends StatefulWidget {
  final Function(String imdbId) onItemInteraction;

  MovieFavoriteListView({Key key, this.onItemInteraction}) : super(key: key);

  @override
  _MovieFavoriteListView createState() => _MovieFavoriteListView();
}

class _MovieFavoriteListView extends State<MovieFavoriteListView> {
  @override
